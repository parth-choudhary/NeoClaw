package com.parth.neoclaw.accessibility
...
/**
 * Android Accessibility Service — enables NeoClaw to interact with
 ...
 */
class NeoClawAccessibilityService : AccessibilityService() {

    companion object {
        private const val TAG = "A11yService"
        var instance: NeoClawAccessibilityService? = null
            private set
