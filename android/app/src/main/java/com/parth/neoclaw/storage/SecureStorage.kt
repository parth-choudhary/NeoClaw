package com.parth.neoclaw.storage
...
class SecureStorage(context: Context) {
    ...
    private val prefs = try {
        ...
        context.getSharedPreferences("neoclaw_secure_prefs", Context.MODE_PRIVATE).edit().clear().apply()
        val file = java.io.File(context.filesDir.parentFile, "shared_prefs/neoclaw_secure_prefs.xml")
