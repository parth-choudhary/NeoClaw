package com.parth.mobileclaw.background
...
class AgentForegroundService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "mobileclaw_agent"
        ...
        if (intent?.action == "EXECUTE_TASK") {
            ...
            if (taskId != null) {
                ...
                kotlinx.coroutines.GlobalScope.launch(kotlinx.coroutines.Dispatchers.IO) {
                    try {
                        val orchestrator = com.parth.mobileclaw.engine.AgentOrchestrator(application)
                        ...
                        if (task != null && task.isEnabled) {
                            ...
                            val notification = NotificationCompat.Builder(this@AgentForegroundService, "mobileclaw_tasks")
